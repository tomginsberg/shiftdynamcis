...
def cifar10(split='train', normalize=True, augment=False, resize=224):
...
def cifar10_1(normalize=True, format_spec='list', resize=224):
    cfg = Config()
    ...
    if resize:
        data = torch.nn.UpsamplingBilinear2d(size=resize)(data)
